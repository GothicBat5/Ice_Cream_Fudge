...
class CreateChecksumFileTests(unittest.TestCase):
    ...
    def generate_checksum_file(self, **overrides):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            os.mkdir(dist_path)
            with open(os.path.join(dist_path, "Django-5.2.4-py3-none-any.whl"), "wb") as f:
            ...
            checksum_file_path = os.path.join(artifacts_path, "Django-5.2.4.checksum.txt")
            kwargs = dict(django_version="5.2.4", release_date="May 7, 2025", checksum_file_path=checksum_file_path,
                wheel_name="Django-5.2.4-py3-none-any.whl", tarball_name="django-5.2.4.tar.gz",
                commit_hash="abc123def456abc123def456abc123def456abc1",
                dist_path=dist_path, pgp_key_id="ABCD1234ABCD1234", pgp_key_url="https://github.com/releaser.gpg",)
    ...
    def test_release_metadata(self):
        ...
        self.assertIn("The 5.2.4 tag points to commit " "abc123def456abc123def456abc123def456abc1.", result,)
