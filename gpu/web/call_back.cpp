...
template <template <typename> class BaseCallbackTemplate, typename R, typename... Args>
...
class WGPUOnceCallback<R(Args...)>
 ...
 private:
  ...
  {
    auto callback = std::unique_ptr<WGPUOnceCallback>(static_cast<WGPUOnceCallback*>(
...
template <typename FunctionType, typename... BoundParameters>
  requires(!base::internal::kIsWeakMethod<
           base::internal::FunctorTraits<FunctionType, BoundParameters...>::is_method, BoundParameters...>)

auto BindWGPUOnceCallback(FunctionType&& function, BoundParameters&&... bound_parameters) 
{
  return MakeWGPUOnceCallback(base::BindOnce(std::forward<FunctionType>(function),
...
auto BindWGPURepeatingCallback(FunctionType&& function,
  ...
  return MakeWGPURepeatingCallback(base::BindRepeating(std::forward<FunctionType>(function),
                          std::forward<BoundParameters>(bound_parameters)...));
}
