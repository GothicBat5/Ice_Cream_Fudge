...
extern "C" {
DLLEXPORT int __cdecl ChromeMain(HINSTANCE instance, sandbox::SandboxInterfaceInfo* sandbox_info,
...
extern "C" {
NO_STACK_PROTECTOR __attribute__((visibility("default"))) int ChromeMain(int argc, const char** argv);
}
#else
...
#error Unknown platform.
  ...
  auto crash_on_detach_resetter = base::ScopedClosureRunner(base::BindOnce(&base::win::SetShouldCrashOnProcessDetach,
